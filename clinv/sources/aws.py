...
Classes:
    ...
    EC2src: Class to gather and manipulate the AWS Ec2 resources.
"""
    ...
    def generate_inventory(self):
        ...
        for zone in self.source_data['hosted_zones']:
            for resource in zone['records']:
                ...
                inventory[resource_id] = Route53({resource_id: resource})
        return inventory


class EC2src():
    """
    Class to gather and manipulate the AWS EC2 resources.
