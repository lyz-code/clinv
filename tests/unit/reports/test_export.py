...
class TestExportReport(ClinvReportBaseTestClass, unittest.TestCase):
    ...
    def test_export_informations_generates_expected_dictionary(self):
        ...
        self.assertEqual(
            self.report._export_informations(),
            exported_data,
        )
