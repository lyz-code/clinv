...
from clinv.config import Config, ConfigError
...
def test_get_returns_default_value_if_inexistent(config: Config) -> None:
    """
    Given: A config object
    When: asked for an inexistent attribute and a default value
