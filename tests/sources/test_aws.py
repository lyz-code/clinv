...
class AWSSourceBaseTestClass(AWSSetupTestClass):
    ...
    Must be combined with a unittest.TestCase that defines:
        * self.class_name the name of the source class to test
    '''
    ...
    def test_user_data_can_be_initialized(self):
        ...
        self.src = self.class_name(desired_user_data)
        self.assertEqual(
            self.src.user_data,
            desired_user_data,
        )
...
class TestRoute53Source(AWSSourceBaseTestClass, unittest.TestCase):
    ...
    def setUp(self):
        ...
        user_data = {}
        self.src = self.class_name(user_data)
